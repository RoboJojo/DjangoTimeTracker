...
class User(models.Model):
    ...
    projects = models.ManyToManyField("Project",blank=True,verbose_name="User's projects",null=True)
...
class Project(models.Model):
    ...
    people = models.ManyToManyField(User,blank=True,null=True,verbose_name="People")
